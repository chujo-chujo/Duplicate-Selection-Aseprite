-- Duplicate Selection (Lite), v1.0.0 (2025-04-18)
-- Author: chujo
...
local settings_file = script_path .. "Duplicate Selection (Lite)_settings.txt"
...
local dlg = Dialog{ title="Duplicate Selection (Lite)" }
...
function createMainDialogBox()
    ...
    dlg = Dialog{ title="Duplicate Selection (Lite)" }
    dlg
        :button{
            id="close",
            text="CLOSE",
